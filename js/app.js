...
(() => {
  ...
  const ee = {
    setBreakpoint: function () {
      ...
      h && s && e.changeDirection(), L(e.params, l);
    ...
    ue(),
      document.querySelector(".header__slider") &&
        new ae(".header__slider", {
          ...
          loop: !0,
          pagination: {
            el: ".slider__pagging, .slider-inspirations__pagging",
            clickable: !0,
          },
          navigation: {
            nextEl: ".slider__next, .slider-inspirations__next",
            prevEl: ".slider__prev, .slider-inspirations__prev",
          },
          on: {},
        }),
      document.querySelector(".inspirations__slider") &&
        new ae(".inspirations__slider", {
          modules: [de, pe, he],
          effect: "fade",
          autoplay: { delay: 3e3, disableOnInteraction: !1 },
          observer: !0,
          ...
          autoHeight: !0,
          speed: 800,
          pagination: { el: ".slider-inspirations__pagging", clickable: !0 },
          navigation: {
            nextEl: ".slider-inspirations__next",
            prevEl: ".slider-inspirations__prev",
          },
          on: {},
        }),
      document.querySelector(".tips__slider") &&
        new ae(".tips__slider", {
          ...
          speed: 800,
          loop: !0,
          pagination: { el: ".tips__pagging", clickable: !0 },
    ...
    Ze = (function () {
      ...
      return (
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              r.LGel.trigger(He, { index: t, delay: s || 0, isFirstSlide: n });
          }, a);
        }),
